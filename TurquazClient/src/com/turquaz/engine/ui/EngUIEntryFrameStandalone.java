 ...
 * @version  $Id: EngUIEntryFrameStandalone.java,v 1.1 2007/01/22 17:02:49 huseyiner Exp $
 */
...
public class EngUIEntryFrameStandalone extends org.eclipse.swt.widgets.Composite
{
	{
	...
	public static void showGUI(Display display)
	{
		...
		EngUIEntryFrameStandalone inst = new EngUIEntryFrameStandalone(shell, SWT.NULL);
	...
	public EngUIEntryFrameStandalone(org.eclipse.swt.widgets.Composite parent, int style)
	{
		super(parent, style);
		initGUI();
	...
	private void initGUI()
	{
		try
		{
			...
			String database = EngDatabase.getString("serverAddress"); //$NON-NLS-1$
	...
	public void showMainFrame()
	{
		...
		{			
			...
			info.put("username",txtUserName.getText());
	...
	public void validateDB(){
		...
		Boolean isVersionUpdated=EngBLVersionValidate.checkVersionWithSession();		 //$NON-NLS-1$
		if (!isVersionUpdated.booleanValue())
		{
			...
			Boolean successfull=EngBLVersionValidate.validateVersionWithSession();//$NON-NLS-1$
	...
	public void btnOkMouseUp()
	{
		...
		try
		{
			...
			Boolean result = (Boolean)EngTXCommon.doSelectTX("authenticate",argMap); //$NON-NLS-1$
