...
/**
 * @author Onsel
 * @version $Id: CurrencyCellEditor.java,v 1.1 2007/01/22 17:02:51 huseyiner Exp $
 */
...
public class CurrencyCellEditor extends TextCellEditor
{
	...
	protected void text3VerifyText(VerifyEvent e)
	{
		...
		if (valid)
		{
			...
			{
				/*
				 * text.setText(""); String toSetEvent=""; String toSetBox=""; if (formatted.length() > offset) {
				 * toSetEvent=formatted.substring(0,offset); toSetBox=formatted.substring(offset); //System.out.println(toSetEvent);
				 * //System.out.println(toSetBox); } else { toSetEvent=formatted; } e.text=toSetEvent; text.setText(toSetBox);
				 * //System.out.println(text.getText()); e.start=-1; e.end=-1; e.doit=true; //System.out.println(text.getText());
				 */
				text.setText("");
				e.text = formatted;
				e.doit = true;
