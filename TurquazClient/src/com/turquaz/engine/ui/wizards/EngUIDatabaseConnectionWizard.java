 ...
 * @version $Id: EngUIDatabaseConnectionWizard.java,v 1.1 2007/01/22 17:02:44 huseyiner Exp $
 */
...
public class EngUIDatabaseConnectionWizard extends Wizard
{
	...
	public boolean performFinish()
	{
		...
		try
		{
			...
			FileOutputStream fileout = new FileOutputStream(EngConfiguration.filename2); //$NON-NLS-1$
