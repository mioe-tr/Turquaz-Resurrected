 ...
 * @version  $Id: EngUIReAuthenticator.java,v 1.1 2007/01/22 17:02:50 huseyiner Exp $
 */
...
public class EngUIReAuthenticator extends org.eclipse.swt.widgets.Composite
{
	...
	public void btnOkMouseUp()
	{
		...
		{
			EngUICommon.showMessageBox(getShell(),"Lütfen port için geçerli bir sayý giriniz!");
		}
		catch (Exception ex)
		{
