 ...
 * @version  $Id: SecureDialog.java,v 1.1 2007/01/22 17:02:38 huseyiner Exp $
 */
...
public class SecureDialog extends org.eclipse.swt.widgets.Dialog
{
	...
	public SecureDialog(Shell parent2, int style)
	{
		...
		final org.eclipse.swt.graphics.Image timDeleteimage = new org.eclipse.swt.graphics.Image(Display.getDefault(), getClass()
				.getClassLoader().getResourceAsStream("icons/delete_edit.gif"));
