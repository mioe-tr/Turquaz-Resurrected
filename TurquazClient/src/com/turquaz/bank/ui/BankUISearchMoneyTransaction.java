...
/**
 * @author  Onsel
 * @version  $Id: BankUISearchMoneyTransaction.java,v 1.1 2007/01/22 17:02:48 huseyiner Exp $
 */
...
public class BankUISearchMoneyTransaction extends org.eclipse.swt.widgets.Composite implements SearchComposite
{
	...
	public void search()
	{
		try
		{
			...
			HashBag resultBag =(HashBag) EngTXCommon.doSelectTX("Bnk_searchtransaction",argMap);
