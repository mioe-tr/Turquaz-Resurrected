...
public class BankUIInitialTransaction extends org.eclipse.swt.widgets.Composite
{
		...
		rowList.addChangeListener(new ITableRowListViewer()
		{
			public void updateRow(ITableRow row)
			{
				try
				{
					...
					EngTXCommon.doTransactionTX("Bnk_updateInitialTransaction",(HashMap)row.getDBObject());
				}
				catch (Exception ex)
				{
	...
	public void fillTable()
	{
		try
		{
			HashBag transBag =(HashBag)EngTXCommon.doSelectTX("Bnk_getBankInitialTransactions",null);
