...
/**
 * @author  Ceday
 * @version  $Id: BankUIBankCardSearch.java,v 1.1 2007/01/22 17:02:48 huseyiner Exp $
 */
...
public class BankUIBankCardSearch extends Composite implements SearchComposite
{
	...
	public void delete()
	{
		try
		{
			...
			if (selection.length > 0)
			{
				...
				if (EngUICommon.okToDelete(getShell()))
				{
	...
	public void search()
	{
		try
		{
			...
			HashBag bankCardsBag =(HashBag) EngTXCommon.doTransactionTX("Bnk_searchBankCards",argMap);
