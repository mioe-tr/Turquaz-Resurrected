...
* 
*/
public class BankUIOtherTransInUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public BankUIOtherTransInUpdate(Shell parent, int style, Integer transBill)
	{
		super(parent, style);
