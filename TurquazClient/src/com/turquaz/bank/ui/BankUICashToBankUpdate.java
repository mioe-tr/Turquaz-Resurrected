...
* 
*/
public class BankUICashToBankUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	private Shell dialogShell;
	private BankUICashToBank compCashTrans;
	...
	public boolean open()
	{
		try
		{
			...
			}
			{
					...
					compCashTrans = new BankUICashToBank(dialogShell, SWT.NONE);
	...
	public void save()
	{
		try
		{
			if (compCashTrans.verifyFields())
			{
				...
				EngTXCommon.doTransactionTX("Bnk_updateCashTransactionBill",argMap);
	...
	public String getSaveComposite() {
		return BankUICashToBank.class.getName();
	}
