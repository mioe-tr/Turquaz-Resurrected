...
public class CashUIInitialTransactions extends org.eclipse.swt.widgets.Composite
{
	...
	public void createTableViewer()
	{
		...
		rowList.addChangeListener(new ITableRowListViewer()
		{
			public void updateRow(ITableRow row)
			{
				try
				{
					EngTXCommon.doTransactionTX("Csh_updateCashInitialTrans",(HashMap)row.getDBObject()); 
				}
				catch (Exception ex)
				{
	...
	public void fillTable()
	{
		try
		{
            HashBag transBag =(HashBag)EngTXCommon.doSelectTX("Csh_getInitialTransactions",null); //$NON-NLS-1$      
