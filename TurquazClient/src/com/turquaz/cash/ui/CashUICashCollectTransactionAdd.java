...
/**
 * @author  Onsel
 * @version  $Id: CashUICashCollectTransactionAdd.java,v 1.1 2007/01/22 17:02:47 huseyiner Exp $
 */
	...
	private void initGUI()
	{
		try
		{
			...
			this.setSize(645, 280);
			{
				...
				lblCashTransType.setText(CashLangKeys.STR_COLLECT_VOUCHER);
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				EngTXCommon.doTransactionTX("Csh_saveCurrentTransaction",argMap);
