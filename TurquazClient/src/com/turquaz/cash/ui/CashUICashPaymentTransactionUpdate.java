...
/**
 * @author  Onsel
 * @version  $Id: CashUICashPaymentTransactionUpdate.java,v 1.1 2007/01/22 17:02:47 huseyiner Exp $
 */
...
* 
*/
public class CashUICashPaymentTransactionUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public CashUICashPaymentTransactionUpdate(Shell parent, int style, HashBag cashBag)
	{
		super(parent, style);
	...
	public void postInitGUI()
	{
		try
		{
			...
			compTransAdd.getTxtCurrentAccount().setText(
					cashBag.get(CurKeys.CUR_CURRENT_NAME) + " {" + cashBag.get(CurKeys.CUR_CURRENT_CODE)
							+ "}");
	...
	public void save()
	{
		try
		{
			if (compTransAdd.verifyFields())
			{
				...
				EngTXCommon.doTransactionTX("Csh_updateCashTrans",argMap );
	...
	public String getSaveComposite() {
		...
		return	CashUICashPaymentTransactionAdd.class.getName();
	}
