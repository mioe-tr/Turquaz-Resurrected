...
/**
 * @author  Onsel
 * @version  $Id: CashUICashCollectTransactionUpdate.java,v 1.1 2007/01/22 17:02:47 huseyiner Exp $
 */
...
public class CashUICashCollectTransactionUpdate extends Dialog implements SaveDialogInterface
{
	...
	public CashUICashCollectTransactionUpdate(Shell parent, int style, HashBag transBag)
	{
		super(parent, style);
		this.cashBag=transBag;
	}
	...
	public String getSaveComposite() {
		return CashUICashCollectTransactionAdd.class.getName();
	}
