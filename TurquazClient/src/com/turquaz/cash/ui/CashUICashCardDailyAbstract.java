...
/**
 * @author  Cem Dayanik
 * @version  $Id: CashUICashCardDailyAbstract.java,v 1.1 2007/01/22 17:02:48 huseyiner Exp $
 */
	...
	private void tableCashTransMouseDoubleClick(MouseEvent evt)
	{
		try
		{
			...
			if (selection.length > 0)
			{
                ...
                HashBag cashBag = (HashBag)EngTXCommon.doSelectTX("Csh_getTransactionInfo",argMap); //$NON-NLS-1$
	...
	public void search()
	{
		if (verifyFields())
		{
			try
			{
				...
				argMap.put(CashKeys.CASH_DAILY,new Boolean(true));
				...
				List ls=(List)abstractBag.get(CashKeys.CASH_TRANSACTIONS);
