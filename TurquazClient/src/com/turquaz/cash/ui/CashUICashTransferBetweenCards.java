...
/**
 * @author  Onsel
 * @version  $Id: CashUICashTransferBetweenCards.java,v 1.1 2007/01/22 17:02:47 huseyiner Exp $
 */
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				EngTXCommon.doTransactionTX("Csh_saveTransferBetweenAccounts",argMap);
