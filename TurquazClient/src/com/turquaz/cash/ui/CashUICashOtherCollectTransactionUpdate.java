...
/**
 * @author  Onsel
 * @version  $Id: CashUICashOtherCollectTransactionUpdate.java,v 1.1 2007/01/22 17:02:47 huseyiner Exp $
 */
...
* 
*/
public class CashUICashOtherCollectTransactionUpdate extends Dialog implements SaveDialogInterface
{
	...
	public CashUICashOtherCollectTransactionUpdate(Shell parent, int style,HashBag cashBag)
	{
		super(parent, style);
	...
	public String getSaveComposite() {
		...
		return CashUICashOtherCollectTransaction.class.getName();
