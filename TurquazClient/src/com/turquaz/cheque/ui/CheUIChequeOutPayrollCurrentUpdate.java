...
/**
 * @author  Onsel
 * @version  $Id: CheUIChequeOutPayrollCurrentUpdate.java,v 1.1 2007/01/22 17:02:45 huseyiner Exp $
 */
...
* *************************************
*/
public class CheUIChequeOutPayrollCurrentUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public String getSaveComposite() {
		...
		return CheUIChequeOutPayrollCurrent.class.getName();
	}
