...
/**
 * @author Onsel
 * @version $Id: CheUIReturnFromBankRollUpdate.java,v 1.1 2007/01/22 17:02:44 huseyiner Exp $
 */
...
*/
public class CheUIReturnFromBankRollUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public CheUIReturnFromBankRollUpdate(Shell parent, int style, Integer chequeRoll)
	{
		super(parent, style);
	...
	public String getSaveComposite() {
		...
		return CheUIReturnFromBankRoll.class.getName();
