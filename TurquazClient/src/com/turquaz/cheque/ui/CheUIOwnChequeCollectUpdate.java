...
/**
 * @author Onsel
 * @version $Id: CheUIOwnChequeCollectUpdate.java,v 1.1 2007/01/22 17:02:45 huseyiner Exp $
 */
...
* *************************************
* 
* @author hakankaynar ot checked
*/
public class CheUIOwnChequeCollectUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	private Shell dialogShell;
	private SaveDialogMenu saveDialogMenu1;
	private CheUIOwnChequeCollect compChequeRoll;
	boolean isUpdated = false;
	Integer chequeRollId = null;

	public CheUIOwnChequeCollectUpdate(Shell parent, int style, Integer chequeRoll)
	{
		super(parent, style);
	...
	public boolean open()
	{
		try
		{
			...
			//START >> compChequeRoll
				...
				compChequeRoll = new CheUIOwnChequeCollect(dialogShell, SWT.NONE);
	...
	public void save()
	{
		try
		{
			if (compChequeRoll.verifyFields())
			{
				...
				EngTXCommon.doTransactionTX("Che_updateOwnChequeCollect",argMap) ;
	...
	public String getSaveComposite() {
		return CheUIOwnChequeCollect.class.getName();
	}
