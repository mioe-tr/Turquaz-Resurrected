...
/**
 * @author Onsel
 * @version $Id: CheUIReturnFromCurrentUpdate.java,v 1.1 2007/01/22 17:02:44 huseyiner Exp $
 */
...
* 
*/
public class CheUIReturnFromCurrentUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public CheUIReturnFromCurrentUpdate(Shell parent, int style, Integer chequeRoll)
	{
		super(parent, style);
	...
	public void save()
	{
		try
		{
			if (compChequeRoll.verifyFields())
			{
				...
				argMap.put(EngKeys.TYPE,EngBLCommon.CHEQUE_TRANS_RETURN_TO_CURRENT);
	...
	public String getSaveComposite() {
		return CheUIReturnFromCurrent.class.getName();		
	}
