...
/**
 * @author  Onsel
 * @version  $Id: CheUICustomerChequeAddDialog.java,v 1.1 2007/01/22 17:02:45 huseyiner Exp $
 */
...
* *************************************
*/
public class CheUICustomerChequeAddDialog extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public HashMap open()
	{
		try
		{
			...
			dialogShell.setSize(526, 364);
			{
				...
				saveDialogMenu1LData.horizontalSpan = 2;
				saveDialogMenu1 = new SaveDialogMenu(dialogShell, SWT.NONE,this,false,false);
