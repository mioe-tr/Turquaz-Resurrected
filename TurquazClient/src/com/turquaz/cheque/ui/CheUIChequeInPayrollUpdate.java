...
/**
 * @author  Onsel
 * @version  $Id: CheUIChequeInPayrollUpdate.java,v 1.1 2007/01/22 17:02:46 huseyiner Exp $
 */
...
* 
* */
public class CheUIChequeInPayrollUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public CheUIChequeInPayrollUpdate(Shell parent, int style, Integer chequeRollId)
	{
		super(parent, style);
	...
	public String getSaveComposite() {
		return CheUIChequeInPayroll.class.getName();
