...
public class CheUIOwnChequeChooseDialog extends org.eclipse.swt.widgets.Dialog
{
	...
	public CheUIOwnChequeChooseDialog(Shell parent, int style, List selectedCheques)
	{
		super(parent, style);
	...
	public List open()
	{
		try
		{
			...
			dialogShell.setText("Verilen Firma Çekleri");
			dialogShell.layout();
			dialogShell.pack();
			...
			//END << toolBar
			{
				...
				tableColumnCurrentCard.setText("Kime Verildi"); //$NON-NLS-1$
	...
	public void fillTable()
	{
		try
		{
			...
			HashBag resultBag = (HashBag)EngTXCommon.doSelectTX("Che_getOwnChequesGivenToCurrent",null);
