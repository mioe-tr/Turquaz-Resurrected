...
/**
 * @author  Onsel
 * @version  $Id: CheUICustomerChequeUpdate.java,v 1.1 2007/01/22 17:02:45 huseyiner Exp $
 */
...
* 
*/
public class CheUICustomerChequeUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public void FillHistory(HashMap chequeRolls)
	{
		try
		{
			...
			if(chequeRolls==null)
			{
				HashMap argMap = new HashMap();
				argMap.put(CheKeys.CHE_CHEQUE_ID,chequeId);
				HashBag historyBag = (HashBag)EngTXCommon.doSelectTX("Che_getChequeHistory",argMap);
