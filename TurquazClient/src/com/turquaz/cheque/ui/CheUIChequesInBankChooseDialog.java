...
public class CheUIChequesInBankChooseDialog extends org.eclipse.swt.widgets.Dialog
{
	...
	public CheUIChequesInBankChooseDialog(Shell parent, int style, List selectedCheques)
	{
		super(parent, style);
	...
	public void fillTable()
	{
		try
		{
			...
			HashBag resultBag = (HashBag)EngTXCommon.doSelectTX("Che_getChequesInBank",null);
