...
public class CheUIChooseGivenChequesDialog extends org.eclipse.swt.widgets.Dialog
{
	...
	public CheUIChooseGivenChequesDialog(Shell parent, int style, List selectedCheques)
	{
		super(parent, style);
	...
	public List open()
	{
		try
		{
			...
			dialogShell.setText(CheLangKeys.TITLE_GIVEN_CHEQUES); //$NON-NLS-1$
			dialogShell.layout();
			dialogShell.pack();
	...
	public void fillTable()
	{
		try
		{
			...
			HashBag resultBag = (HashBag)EngTXCommon.doSelectTX("Che_getChequesGivenToCurrent",null);
