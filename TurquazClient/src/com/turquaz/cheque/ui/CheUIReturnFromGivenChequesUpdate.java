...
/**
 * @author Onsel
 * @version $Id: CheUIReturnFromGivenChequesUpdate.java,v 1.1 2007/01/22 17:02:44 huseyiner Exp $
 */
...
* 
*/
public class CheUIReturnFromGivenChequesUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public CheUIReturnFromGivenChequesUpdate(Shell parent, int style,Integer chequeRollId)
	{
		super(parent, style);
	...
	public void save()
	{
		try
		{
			if (compChequeRoll.verifyFields())
			{
                ...
                argMap.put(EngKeys.TYPE,EngBLCommon.CHEQUE_TRANS_RETURN_FROM_CURRENT);
	...
	public String getSaveComposite() {
			...
			return CheUIReturnFromGivenCheques.class.getName();
