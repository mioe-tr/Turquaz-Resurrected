...
/**
 * @author Onsel
 * @version $Id: CheUIChequeCollectFromBankUpdate.java,v 1.1 2007/01/22 17:02:45 huseyiner Exp $
 */
...
* 
*/
public class CheUIChequeCollectFromBankUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
	...
	public void postInitGUI()
	{
		...
		//	compChequeRoll.getToolItemDelete().setEnabled(false);
			...
			HashBag rollBag = (HashBag)EngTXCommon.doSelectTX("Che_getChequeRollInfo",argMap);
	...
	public String getSaveComposite() {
		...
		return CheUIChequeCollectFromBank.class.getName();
