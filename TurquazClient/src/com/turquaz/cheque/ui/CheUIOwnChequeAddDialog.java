...
/**
 * @author  Onsel
 * @version  $Id: CheUIOwnChequeAddDialog.java,v 1.1 2007/01/22 17:02:44 huseyiner Exp $
 */
...
public class CheUIOwnChequeAddDialog extends org.eclipse.swt.widgets.Dialog
{
	...
	public void save()
	{
		if (verifyFields())
		{
			...
			chequeInfo.put(BankKeys.BANK_CODE,bankPicker.getBankCode());
			chequeInfo.put(BankKeys.BANK_ACCOUNT_NO,bankPicker.getBankAccountNo());
