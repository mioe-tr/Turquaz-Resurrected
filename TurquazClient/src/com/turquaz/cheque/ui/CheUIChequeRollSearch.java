...
/**
 * @author  Onsel
 * @version  $Id: CheUIChequeRollSearch.java,v 1.1 2007/01/22 17:02:45 huseyiner Exp $
 */
...
public class CheUIChequeRollSearch extends org.eclipse.swt.widgets.Composite implements SearchComposite
{
	...
	public void postInitGUI()
	{
		try
		{
			...
			HashBag typeBag =(HashBag)EngTXCommon.doSelectTX("Che_getTransactionTypes",null);
	...
	public void search()
	{
		try
		{
			...
			HashBag infoBag = (HashBag)EngTXCommon.doSelectTX("Che_searchChequeRoll",argMap );
