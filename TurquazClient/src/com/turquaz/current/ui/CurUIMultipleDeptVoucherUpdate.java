...
public class CurUIMultipleDeptVoucherUpdate extends org.eclipse.swt.widgets.Dialog implements SaveDialogInterface
{
		...
		try
		{
			if (compVoucher.verifyFields())
			{
				...
				HashBag resultMap = (HashBag) EngTXCommon.doTransactionTX(
						"Cur_updateMultipleOtherTransaction", argMap);
	...
	public String getSaveComposite() {
		return CurUIMultipleDeptVoucher.class.getName();
	}
