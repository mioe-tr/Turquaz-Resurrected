...
public class CurUICurCardCreditList extends Composite implements SearchComposite
{
	...
	public void initGUI()
	{
		try
		{
			...
			tableColumnBalance.setText(EngLangCommonKeys.STR_BALANCE_CREDIT);
	...
	public void search()
	{
		try
		{
			...
			HashBag result = (HashBag)EngTXCommon.doSelectTX("Cur_searchCurrentCardBalanceList",argMap);
	...
	{
		EngBLUtils.printTable(tableCurrentCardSearch, CurLangKeys.STR_CUR_CREDIT_LIST); //$NON-NLS-1$
	}
