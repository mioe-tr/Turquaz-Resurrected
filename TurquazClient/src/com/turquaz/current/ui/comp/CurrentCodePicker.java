 ...
 * @version  $Id: CurrentCodePicker.java,v 1.1 2007/01/22 17:03:10 huseyiner Exp $
 */
		...
		else
		{
			...
			if (accountPicker != null)
			{
				try
				{
					...
					HashBag account_code=(HashBag)EngTXCommon.doSelectTX("Cur_getCurrentAccountingAccount",argMap);
								
					accountPicker.setText(account_code.get(AccKeys.ACC_ACCOUNT_CODE).toString());
