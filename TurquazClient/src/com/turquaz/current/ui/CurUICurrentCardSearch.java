 ...
 * @version  $Id: CurUICurrentCardSearch.java,v 1.1 2007/01/22 17:02:39 huseyiner Exp $
 */
...
public class CurUICurrentCardSearch extends Composite implements SearchComposite
{
	...
	public void search()
	{
		try
		{
			...
			HashBag result = (HashBag)EngTXCommon.doSelectTX("Cur_searchCurrentCard",argMap);
