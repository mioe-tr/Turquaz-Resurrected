 ...
 * @version  $Id: CurUIGroupAddDialog.java,v 1.1 2007/01/22 17:02:39 huseyiner Exp $
 */
		...
		try
		{
			...
			dialogShell.setLayout(dialogShellLayout);
			{
				...
				}
				{
					...
					txtGroupNameLData.heightHint = 14;
				...
				}
				{
					...
					txtDescriptionLData.heightHint = 15;
	...
	protected void btnDeleteMouseUp(MouseEvent evt)
	{
		...
		try
		{
			...
			if (result == SWT.OK)
			{
				...
				EngTXCommon.doTransactionTX("Cur_deleteGroup",argMap);
	...
	protected void btnUpdateMouseUp(MouseEvent evt)
	{
		...
		try
		{
			...
			else
			{
			    ...
			    EngTXCommon.doTransactionTX("Cur_updateGroup",argMap);
	...
	protected void btnGroupAddMouseUp()
	{
		...
		try
		{
			...
			else
			{
				...
				EngTXCommon.doTransactionTX("Cur_saveCurrentGroup",argMap);
