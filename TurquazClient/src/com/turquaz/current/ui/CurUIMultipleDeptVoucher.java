 ...
 * @version  $Id: CurUIMultipleDeptVoucher.java,v 1.1 2007/01/22 17:02:39 huseyiner Exp $
 */
    ...
    public void initGUI()
    {
        try
        {
            ...
            //END <<  tableTransactionRows
			{
				...
				composite1LData.widthHint = 10;
				composite1LData.heightHint = 22;
				composite1.setLayoutData(composite1LData);
				composite1Layout.numColumns = 2;
				GridData composite1LData1 = new GridData();
				composite1LData1.heightHint = 35;
				composite1LData1.horizontalAlignment = GridData.FILL;
				composite1LData1.horizontalSpan = 4;
				composite1.setLayoutData(composite1LData1);
				composite1.setLayout(composite1Layout);
				{
					lblTotals = new CLabel(composite1, SWT.NONE);
					lblTotals.setText(EngLangCommonKeys.STR_TOTAL_PRICE);
				}
				{
					GridData txtTotalLData = new GridData();
					txtTotalLData.widthHint = 192;
					txtTotalLData.heightHint = 19;
					txtTotal = new Text(composite1, SWT.NONE);
    ...
    public void save()
	{
		if (verifyFields())
		{
			try
			{
				...
				argMap
						.put(EngKeys.CURRENCY_ID, comboCurrencyType.getData(comboCurrencyType.getText()));
				HashBag resultMap = (HashBag) EngTXCommon.doTransactionTX(
						"Cur_saveMultipleOtherTransaction", argMap);
