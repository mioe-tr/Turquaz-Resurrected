 ...
 * @version  $Id: BillUIAddBill.java,v 1.1 2007/01/22 17:02:39 huseyiner Exp $
 */
...
public class BillUIAddBill extends Composite implements SecureComposite
{
					...
					tabItemGeneral.setImage(SWTResourceManager.getImage("icons/Home16.gif")); //$NON-NLS-1$
					{
						...
						tabItemGeneral.setControl(compGeneral);
						{
							...
							}
							{
								...
								GridLayout txtCurrentCardLayout = new GridLayout();
								txtCurrentCardLayout.numColumns = 3;
								...
								txtCurrentCardLData.heightHint = 20;
							...
							}
							{
								...
								GridLayout dateConsignmentDateLayout = new GridLayout();
								dateConsignmentDateLayout.numColumns = 4;
							...
							txtConsignmentDateLData.widthHint = 142;
							txtConsignmentDateLData.heightHint = 16;
							...
							txtConsignmentDate.setEnabled(false);
	...
	public boolean checkStabilityInventoryLevel(Integer cardId)
	{
		try
		{
			...
			HashBag amountInfo = (HashBag)EngTXCommon.doSelectTX("Inv_getView",argMap);
	...
	public void calculateTotals()
	{
		...
		txtSubTotal.setText(subTotal.add(totalSpecVAT).subtract(discountTotal));
