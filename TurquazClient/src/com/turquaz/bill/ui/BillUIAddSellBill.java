 ...
 * @version $Id: BillUIAddSellBill.java,v 1.1 2007/01/22 17:02:39 huseyiner Exp $
 */
					...
					tabItemGeneral.setImage(SWTResourceManager.getImage("icons/Home16.gif")); //$NON-NLS-1$
					{
						...
						tabItemGeneral.setControl(compGeneral);
						{
							...
							lblConsignemntDate = new CLabel(
								compInfoPanel,
								SWT.NONE);
							lblConsignemntDate.setText(ConsLangKeys.STR_CONS_DATE);
...
//			 Fill Group Table
	...
	public boolean checkStabilityInventoryLevel()
    {
        try
        {
			...
			argMap.put(EngKeys.TYPE, new Integer(EngBLCommon.COMMON_SELL_INT));
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
                ...
                argMap.put(CashKeys.CASH_CARD_ID,cashPicker.getCashCardId());
