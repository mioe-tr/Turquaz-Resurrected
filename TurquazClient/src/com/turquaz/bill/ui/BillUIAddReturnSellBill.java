 ...
 * @version  $Id: BillUIAddReturnSellBill.java,v 1.1 2007/01/22 17:02:39 huseyiner Exp $
 */
                    ...
                    tabItemGeneral.setImage(SWTResourceManager.getImage("icons/Home16.gif")); //$NON-NLS-1$
                    {
                        ...
                        tabItemGeneral.setControl(compGeneral);
                        {
                            ...
                            }
                            {
                                ...
                                txtCurrentCardLData.widthHint = 391;
                            ...
                            //END <<  lblConsDate
                            {
                                ...
                                dateDueDateLData.widthHint = 143;
                            ...
                            }
                            {
                                ...
                                comboWareHouseLData.widthHint = 123;
...
//			 Fill Group Table
	...
	public boolean checkStabilityInventoryLevel()
    {
        try
        {
			...
			argMap.put(EngKeys.TYPE, new Integer(EngBLCommon.COMMON_RETURN_SELL_INT));
