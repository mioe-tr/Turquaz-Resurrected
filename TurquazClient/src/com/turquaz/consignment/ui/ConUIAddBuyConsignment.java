 ...
 * @version  $Id: ConUIAddBuyConsignment.java,v 1.1 2007/01/22 17:02:50 huseyiner Exp $
 */
...
public class ConUIAddBuyConsignment extends org.eclipse.swt.widgets.Composite implements SecureComposite {
			...
			this.setSize(979, 535);
			{
				...
				tabItemInfo.setText(EngLangCommonKeys.STR_GENERAL_INFO);
				{
					...
					compGeneral.setLayout(compGeneralLayout);
					{
						...
						{
							txtDefinition = new Text(compInfoPanel, SWT.WRAP
								| SWT.V_SCROLL);
	...
	public void fillGroupsTable() {
		try {
			// Fill Group Table
			HashBag groupBag = (HashBag) EngTXCommon.doSelectTX("Con_getConsignmentGroups", null);
	...
	public void save() {
		try {
			if (verifyFields()) {
			    ...
			    EngTXCommon.doTransactionTX("Con_saveConsignment", argMap);
