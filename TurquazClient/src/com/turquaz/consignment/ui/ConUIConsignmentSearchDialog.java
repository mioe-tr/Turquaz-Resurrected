...
public class ConUIConsignmentSearchDialog extends org.eclipse.swt.widgets.Dialog
{
		...
		try
		{
			...
			dialogShell.setText(ConsLangKeys.TITLE_CONS_SEARCH);
			{
				...
				}
				{
					...
					txtCurCardLData.widthHint = 417;
					txtCurCardLData.heightHint = 18;
				...
				}
				{
					...
					comboCurrencyTypeLData.widthHint = 129;
					comboCurrencyTypeLData.heightHint = 16;
	...
	public void search()
	{
		try
		{
			if (verifyFields())
			{
				...
				HashBag consBag = (HashBag) EngTXCommon.doSelectTX("Con_chooseConsignment", argMap);
	...
	private void toolOkWidgetSelected(SelectionEvent evt)
	{
		...
		result[0] = curCardId;
		result[2]= curName;
		result[3]= comboCurrencyType.getData(comboCurrencyType.getText());
		result[4]= comboCurrencyType.getText();
