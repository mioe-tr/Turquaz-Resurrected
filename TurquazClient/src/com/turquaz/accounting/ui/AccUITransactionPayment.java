 ...
 * @version  $Id: AccUITransactionPayment.java,v 1.1 2007/01/22 17:02:49 huseyiner Exp $
 */
...
public class AccUITransactionPayment extends Composite implements SecureComposite
{
	...
	public void save()
	{
		if (verifyFields())
		{
			try
			{
				...
				EngTXCommon.doTransactionTX("Acc_saveAccTransactionFromUI",argMap);			
	...
	public List getTransactionColumns()
	{
		...
		if (transColumns.size() > 0)
		{
			...
			counterRow.put(AccKeys.ACC_TRANS_ROW_DEFINITION,txtDefinition.getText());
