 ...
 * @version  $Id: AccUISearchAccountsDialog.java,v 1.1 2007/01/22 17:02:49 huseyiner Exp $
 */
...
public class AccUISearchAccountsDialog extends org.eclipse.swt.widgets.Dialog implements SearchDialogInterface
{
    ...
    public void search()
    {
        try
        {
            ...
            HashBag mainBranches = (HashBag) EngTXCommon.doSelectTX("Acc_searchAccounts", argMap);
            TableItem item ;
