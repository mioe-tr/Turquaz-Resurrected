 ...
 * @version  $Id: AccUITransactionCollect.java,v 1.1 2007/01/22 17:02:49 huseyiner Exp $
 */
...
public class AccUITransactionCollect extends Composite implements SecureComposite
{
	...
	public List getTransactionColumns()
	{
		...
		if (transColumns.size() > 0)
		{
			...
			counterRow.put(AccKeys.ACC_TRANS_ROW_DEFINITION,txtTransDefinition.getText());
	...
	void calculateTotalDept()
	{
		...
		txtTotal.setText(cf.format(totalDept));
