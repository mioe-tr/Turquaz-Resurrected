 ...
 */
public class MainAccountPicker extends org.eclipse.swt.widgets.Composite implements TurquazContentAssistInterface
{
	{
	...
	public MainAccountPicker(Composite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
			...
			this.setLayout(thisLayout);
			{
				...
				modifyListener=new ModifyListener()
				{
					public void modifyText(ModifyEvent evt)
					{
						try
						{
							HashMap accMap=EngBLAccountingAccounts.getMainAccount(text1.getText().trim());
							setDataMap(accMap);							
						}
						catch (Exception ex)
						{
