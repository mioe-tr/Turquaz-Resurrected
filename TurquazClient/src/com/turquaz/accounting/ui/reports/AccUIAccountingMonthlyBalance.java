...
/**
 * @author  Cem Dayanik
 * @version  $Id: AccUIAccountingMonthlyBalance.java,v 1.1 2007/01/22 17:02:37 huseyiner Exp $
 */
	...
	private void initGUI()
	{
		try
		{
			...
			this.setSize(654, 402);
			{
				...
				{
					accountPickerStart = new MainAccountPicker(compAdvanced, SWT.NONE);
				...
				{
					accountPickerEnd = new MainAccountPicker(compAdvanced, SWT.NONE);
