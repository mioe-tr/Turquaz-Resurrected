 ...
 * @version  $Id: AdmUIGroups.java,v 1.1 2007/01/22 17:02:40 huseyiner Exp $
 */
...
public class AdmUIGroups extends org.eclipse.swt.widgets.Composite implements SecureComposite, SearchComposite
{
			...
			if (selection.length > 0)
			{
				...
				if (groupNumber != null)
				{
					...
					if (delete)
					{
						...
						EngTXCommon.doTransactionTX("Adm_deleteGroup",argMap); //$NON-NLS-1$
	...
	public void fillTable()
	{
		try
		{
			...
			HashBag groupBag =(HashBag)EngTXCommon.doSelectTX("Adm_getGroups",null); //$NON-NLS-1$
