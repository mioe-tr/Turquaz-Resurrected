 ...
 * @version  $Id: AdmUIUsers.java,v 1.1 2007/01/22 17:02:40 huseyiner Exp $
 */
...
public class AdmUIUsers extends org.eclipse.swt.widgets.Composite implements SecureComposite, SearchComposite
{
	...
	public void delete()
	{
		...
		if (selection.length > 0)
		{
			...
			if (delete)
			{
				...
				EngTXCommon.doTransactionTX("Adm_deleteUser",argMap);
				fillTable();
			}
		}
		}
	...
	public void fillTable()
	{
		try
		{
			...
			HashBag usersBag = (HashBag)EngTXCommon.doSelectTX("Adm_getUsers",null);
