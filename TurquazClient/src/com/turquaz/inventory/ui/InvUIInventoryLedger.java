	...
	private void initGUI()
	{
		try
		{
			...
			this.setSize(667, 356);
			{
                ...
                //START >>  lblWarehouse
                lblWarehouse = new CLabel(compFilter, SWT.NONE);
                ...
                comboWareHouse = new CCombo(compFilter, SWT.NONE);
...
//      fill combo ware houses
	...
	public void search()
	{
		try
		{
			...
			HashBag ledgerBag = (HashBag)EngTXCommon.doSelectTX("Inv_getInventoryLedger",argMap);
