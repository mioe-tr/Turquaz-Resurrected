 ...
 * @version  $Id: InvUIWarehouseAdd.java,v 1.1 2007/01/22 17:02:34 huseyiner Exp $
 */
...
public class InvUIWarehouseAdd extends Composite implements SecureComposite
{
	...
	public void initGUI()
	{
		try
		{
			...
			txtWarehouseDescription.addListener(SWT.Traverse,new Listener(){
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				EngTXCommon.doTransactionTX("Inv_saveWarehouse",argMap);
