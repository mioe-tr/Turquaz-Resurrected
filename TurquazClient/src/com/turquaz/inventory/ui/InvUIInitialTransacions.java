...
/**
 * @author onsel
 * @version $Id: InvUIInitialTransacions.java,v 1.1 2007/01/22 17:02:34 huseyiner Exp $
 */
...
public class InvUIInitialTransacions extends org.eclipse.swt.widgets.Composite
{
	...
	public void fillTable()
	{
		try
		{
			HashBag transBag = (HashBag)EngTXCommon.doSelectTX("Inv_getInitialTransactions",null);
		...
		tableViewer.addChangeListener(new ITableRowListViewer()
		{
			...
			public void updateRow(ITableRow row)
			{
				try
				{
					...
					EngTXCommon.doTransactionTX("Inv_updateInitialTransaction",argMap);
				}
				catch (Exception ex)
				{
