 ...
 * @version  $Id: InvUIWarehouseSearch.java,v 1.1 2007/01/22 17:02:33 huseyiner Exp $
 */
...
public class InvUIWarehouseSearch extends Composite implements SecureComposite, SearchComposite
{
	...
	public void search()
	{
		try
		{
			...
			HashBag resultBag = (HashBag)EngTXCommon.doSelectTX("Inv_searchWarehouse",argMap );
		...
		try
		{
			...
			if (selection.length > 0)
			{
				...
				if (okToDelete)
				{
					...
					EngTXCommon.doTransactionTX("Inv_deleteWarehouse",
							argMap);
