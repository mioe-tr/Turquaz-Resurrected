 ...
 * @version  $Id: InventoryPicker.java,v 1.1 2007/01/22 17:03:10 huseyiner Exp $
 */
...
public class InventoryPicker extends org.eclipse.swt.widgets.Composite implements TurquazContentAssistInterface
{
	...
	private HashMap invCardMap=null;
		...
		else
		{
			...
			if (comboUnits != null)
			{
				...
				try
				{
					...
					HashBag unitBag = (HashBag)EngTXCommon.doSelectTX("Inv_getInventoryUnits",argMap);
