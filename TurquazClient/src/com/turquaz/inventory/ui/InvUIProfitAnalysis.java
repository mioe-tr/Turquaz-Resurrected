 ...
 * @version  $Id: InvUIProfitAnalysis.java,v 1.1 2007/01/22 17:02:34 huseyiner Exp $
 */
...
public class InvUIProfitAnalysis extends org.eclipse.swt.widgets.Composite implements SearchComposite
{
	...
	public void search()
	{
		try
		{
			...
			HashBag totalBag = (HashBag)EngTXCommon.doSelectTX("Inv_getTransactionTotals",null);
