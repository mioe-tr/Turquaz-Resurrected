...
/**
 * This class is intended for subclassing. It offers functionality for displaying a picture in the dialog´s header and for adding buttons
 * (right- and left-adjusted) in the dialogs footer. Additionally, it offers an easy tool bar creating mechanism. The events generated by
 * buttons and toolitems can be handled in the method onButton and onToolItem. If not changed by the customer, the main Layout guiMainLayout
...
public class KDialog
{
	...
	/**
	 * Factorymethod for pre-configured GridData objects Configurates: grabExcessHorizontalSpace = true horizontalAlignment =
	 * GridData.BEGINNING
	 * 
	 * @return GridData
	 */
	...
	/**
	 * Factorymethod for pre-configured GridData objects Configurates: grabExcessHorizontalSpace = true horizontalAlignment = GridData.FILL
	 * horizontalSpan = columns verticalAlignment = GridData.FILL
	 * 
	 * @return GridData
	 */
	...
	/**
	 * Factorymethod for pre-configured GridData objects Configurates: grabExcessHorizontalSpace = true horizontalAlignment = GridData.FILL
	 * horizontalSpan = columns verticalAlignment = GridData.FILL horizontalIndent = hIndent
	 * 
	 * @return GridData
	 */
	...
	/**
	 * Returns the style of the dialog. Is also used during shell creation. Overwrite this method to give your dialog another style.
	 * 
	 * @return int
	 */
	...
	/**
	 * This method should create the dialogs GUI and is NOT called by the KDialog constructor. Overwrite this method to build add your own
	 * widgets to the dialog. Do not forget to call it in your own constructor.
	 */
	protected void createContents()
	{
		/*
		 * new Text(guiMainArea,SWT.BORDER); addButton("Ha!",""); addButton("Du langer Button",""); addButtonRight("Close","");
		 * addButtonRight("Komfort","",true);
		 */
	}

	/**
	 * Overwrite this method, if you whish your dioalog having a specific size (use guiShell.setSize())
	 */
	...
	/**
	 * This method opens the dialogs and processes events until the shell is closed. You do not need to overwrite this method. Use close()
	...
	/**
	 * This method centers the dialog on the screen. Overwrite this method if you whish another position.
	 */
	protected void doPositioning()
	{
		guiShell.setLocation((guiDisplay.getBounds().width - guiShell.getBounds().width) / 2, (guiDisplay.getBounds().height - guiShell
				.getBounds().width) / 2);
	}
	...
	/**
	 * Adds a ToolItem to the dialog's toolbar. Creates the toolbar if not already done.
	 * 
	 * @param name
	 *             The name if the ToolItem. Although this name is never displayed to the user you can use it in onToolItem to identify the
	 *             activated ToolItem.
	 * @param tooltip
	 *             The item's tooltip
	 * @param icon
	...
	protected Button addButton(boolean rightAdjusted, String text, String tip)
	{
		...
		erg.addMouseListener(new MouseAdapter()
		{
	...
	/**
	 * Puts a Button into the button bar in the dialog's footer (right adjusted). To handle the event produced by this button see
	 * onButton().
	 * 
	 * @param text
	 * @param toolTip
	...
	/**
	 * Puts a Button into the button bar in the dialog's footer (left adjusted). To handle the event produced by this button see
	 * onButton().
	 * 
	 * @param text
	 * @param toolTip
	...
	/*
	 * clicked ToolItems call this method. Overwrite it to react on button clicks.
	 */
