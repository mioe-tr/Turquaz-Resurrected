...
public class PrintPreview extends KDialog
{
	...
	public PrintPreview(Shell parent, String title, Image icon, PDocument doc)
	{
		...
		guiPageLabel
				.setText(Messages.getString("PrintPreview.26") + page + Messages.getString("PrintPreview.27") + document.getNumOfPages() + Messages.getString("PrintPreview.28")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void onToolItem(ToolItem toolitem, String name)
	{
		if (name.equals("next")) //$NON-NLS-1$
		{
			if (page < document.getNumOfPages())
			{
				...
				guiImageLabel.setImage(getPageImage(page));
				guiPageLabel
						.setText(Messages.getString("PrintPreview.2") + page + Messages.getString("PrintPreview.34") + document.getNumOfPages()); //$NON-NLS-1$ //$NON-NLS-2$
			}
		}
		else if (name.equals("prev")) //$NON-NLS-1$
		{
			if (page > 1)
			{
				...
				guiImageLabel.setImage(getPageImage(page));
				guiPageLabel
						.setText(Messages.getString("PrintPreview.3") + page + Messages.getString("PrintPreview.37") + document.getNumOfPages()); //$NON-NLS-1$ //$NON-NLS-2$
			}
		}
		else if (name.equals(Messages.getString("PrintPreview.38"))) //$NON-NLS-1$
		{
			...
			guiImageLabel.setImage(getPageImage(page));
			guiPageLabel
					.setText(Messages.getString("PrintPreview.39") + page + Messages.getString("PrintPreview.40") + document.getNumOfPages()); //$NON-NLS-1$ //$NON-NLS-2$
		}
		else if (name.equals("last")) //$NON-NLS-1$
		{
			...
			guiImageLabel.setImage(getPageImage(page));
			guiPageLabel
					.setText(Messages.getString("PrintPreview.42") + page + Messages.getString("PrintPreview.43") + document.getNumOfPages()); //$NON-NLS-1$ //$NON-NLS-2$
		}
	...
	protected void onButton(Button button, String buttonText)
	{
		...
		if (buttonText.startsWith(Messages.getString("PrintPreview.45")))close(); //$NON-NLS-1$
