...
public class InvLangKeys
{
	...
	public final static String MSG_WARNING_UNDER_THE_MIN_LEVEL_INV_CARD=Messages.getString("InvLangKeys.92"); //$NON-NLS-1$
	public final static String MSG_WARNING_OVER_THE_MAX_LEVEL_INV_CARD=Messages.getString("InvLangKeys.94"); //$NON-NLS-1$
	public final static String MSG_ARE_YOU_WILLING_TO_CONTINUE=Messages.getString("InvLangKeys.93"); //$NON-NLS-1$
	...
	public final static String TITLE_INV_TRANS_IN_UPDATE=Messages.getString("InvLangKeys.95"); //$NON-NLS-1$
	public final static String TITLE_INV_TRANS_OUT_UPDATE=Messages.getString("InvLangKeys.96"); //$NON-NLS-1$
	
	public final static String MSG_ENTER_PRICE=Messages.getString("InvLangKeys.97"); //$NON-NLS-1$
	public final static String MSG_YOU_CAN_ONLY_DEFINE_ONE_PRICE_PER_CURRENCY=Messages.getString("InvLangKeys.98"); //$NON-NLS-1$
