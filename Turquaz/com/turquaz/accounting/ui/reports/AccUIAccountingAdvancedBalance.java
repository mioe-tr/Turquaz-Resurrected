...
/**
 * @author  Cem Dayanik
 * @version  $Id: AccUIAccountingAdvancedBalance.java,v 1.27 2005/03/18 17:46:58 onsel Exp $
 */
...
public class AccUIAccountingAdvancedBalance extends org.eclipse.swt.widgets.Composite implements SearchComposite
{
	...
	public void search()
	{
		try
		{
			...
			List allAccounts = AccBLTransactionSearch.getTransactions(accountPickerStart.getData(), accountPickerEnd.getData(),
					checkInitialAccounts.getSelection(), datePickerStart.getDate(), datePickerEnd.getDate());
