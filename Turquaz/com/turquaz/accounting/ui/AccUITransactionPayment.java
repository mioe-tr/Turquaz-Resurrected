 ...
 * @version  $Id: AccUITransactionPayment.java,v 1.52 2005/03/26 15:06:18 onsel Exp $
 */
	...
	public void save()
	{
		if (verifyFields())
		{
			...
			try
			{
				...
				AccBLTransactionAdd.saveAccTransaction(datePickerTransactionDate.getDate(), txtDocumentNo.getText().trim(), 1, 1, null,
