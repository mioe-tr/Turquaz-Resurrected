...
* @version  $Id: AccUITransactionPayment.java,v 1.9 2004/11/18 11:09:04 onsel Exp $
*/
...
public class AccUITransactionPayment extends Composite implements SecureComposite{
	...
	*
	**/
	Integer transId =blTransAdd.saveAccTransaction(datePickerTransactionDate.getDate(),txtDocumentNo.getText().trim(),1,1,null);
