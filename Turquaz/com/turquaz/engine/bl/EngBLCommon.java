 ...
 * @version $Id: EngBLCommon.java,v 1.112 2005/05/24 12:54:02 cemdayanik Exp $
 */
...
public class EngBLCommon
{
	...
	public static String VERSION = "0.7.7 Beta 7"; //$NON-NLS-1$
	public static String DATABASE_VERSION="0.7.7"; //$NON-NLS-1$
