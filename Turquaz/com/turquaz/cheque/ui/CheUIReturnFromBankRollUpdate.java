...
/**
 * @author Onsel
 * @version $Id: CheUIReturnFromBankRollUpdate.java,v 1.5 2005/03/19 12:48:30 cemdayanik Exp $
 */
...
public class CheUIReturnFromBankRollUpdate extends org.eclipse.swt.widgets.Dialog
{
	private Shell dialogShell;
	private ToolItem toolUpdate;
	private CheUIReturnFromBankRoll compChequeRoll;
	...
	public CheUIReturnFromBankRollUpdate(Shell parent, int style, TurqChequeRoll chequeRoll)
	{
		super(parent, style);
	...
	public boolean open()
	{
		try
		{
			...
			compChequeRoll = new CheUIReturnFromBankRoll(dialogShell, SWT.NONE);
		...
		try
		{
			if (compChequeRoll.verifyFields())
			{
				...
				CheBLUpdateChequeRoll.updateChequeRollIn(chequeRoll, compChequeRoll.getAccountPicker().getTurqAccountingAccount(),
						null, null, compChequeRoll.getTxtRollNo().getText().trim(), compChequeRoll.getDatePicker1().getDate(),
						chequeList, EngBLCommon.CHEQUE_TRANS_RETURN_FROM_BANK_TO_PORTFOY.intValue(), false, EngBLCommon
