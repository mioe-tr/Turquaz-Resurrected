...
/**
 * @author Onsel
 * @version $Id: CheUIOwnChequeCollectUpdate.java,v 1.3 2005/04/25 13:25:31 onsel Exp $
 */
...
public class CheUIOwnChequeCollectUpdate extends org.eclipse.swt.widgets.Dialog
{
	...
	public CheUIOwnChequeCollectUpdate(Shell parent, int style, TurqChequeRoll chequeRoll)
	{
		super(parent, style);
	...
	private void toolUpdateWidgetSelected(SelectionEvent evt)
	{
		try
		{
			if (compChequeRoll.verifyFields())
			{
				...
				EngTXCommon.doTransactionTX(CheBLUpdateChequeRoll.class.getName(),"updateOwnChequeCollect",argMap) ;
