...
/**
 * @author  Onsel
 * @version  $Id: CheUIChequeCollectFromBank.java,v 1.11 2005/06/13 18:07:31 onsel Exp $
 */
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				EngTXCommon.doTransactionTX(CheBLSaveChequeTransaction.class.getName(),"saveCollectFromBank",argMap);
