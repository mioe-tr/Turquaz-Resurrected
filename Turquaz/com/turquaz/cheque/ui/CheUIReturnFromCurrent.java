...
/**
 * @author  Onsel
 * @version  $Id: CheUIReturnFromCurrent.java,v 1.11 2005/05/04 10:34:58 onsel Exp $
 */
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				EngTXCommon.doTransactionTX(CheBLSaveChequeTransaction.class.getName(),"saveReturnToCurrent",argMap);
