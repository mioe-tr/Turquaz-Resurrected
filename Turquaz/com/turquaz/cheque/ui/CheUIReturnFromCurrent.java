...
/**
 * @author  Onsel
 * @version  $Id: CheUIReturnFromCurrent.java,v 1.6 2005/03/19 12:48:31 cemdayanik Exp $
 */
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				CheBLSaveChequeTransaction.saveReturnToCurrent(null, txtRollNo.getText().trim(), datePicker1.getDate(), cheques);
