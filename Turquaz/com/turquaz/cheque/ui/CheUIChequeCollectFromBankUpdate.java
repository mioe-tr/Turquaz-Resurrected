...
/**
 * @author Onsel
 * @version $Id: CheUIChequeCollectFromBankUpdate.java,v 1.3 2005/03/02 13:14:32 cemdayanik Exp $
 */
...
public class CheUIChequeCollectFromBankUpdate extends
	...
	public CheUIChequeCollectFromBankUpdate(Shell parent, int style,
	...
	public boolean open() {
		try {
			...
			compChequeRoll = new CheUIChequeCollectFromBank(dialogShell,
					SWT.NONE);
