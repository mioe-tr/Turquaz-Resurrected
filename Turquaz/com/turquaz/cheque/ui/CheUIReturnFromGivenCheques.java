...
/**
 * @author  Onsel
 * @version  $Id: CheUIReturnFromGivenCheques.java,v 1.7 2005/04/01 15:15:26 onsel Exp $
 */
 ...
 */
public class CheUIReturnFromGivenCheques extends org.eclipse.swt.widgets.Composite implements SecureComposite
{
	{
	...
	public CheUIReturnFromGivenCheques(org.eclipse.swt.widgets.Composite parent, int style)
	{
		super(parent, style);
		initGUI();
	}
	...
	public void save()
	{
		try
		{
			if (verifyFields())
			{
				...
				EngTXCommon.doTransactionTX(CheBLSaveChequeTransaction.class.getName(),"saveReturnFromCurrent",argMap);
	...
	{
		cheques = new CheUIChooseGivenChequesDialog(getShell(), SWT.NULL, cheques).open();
		fillTable();
	}
