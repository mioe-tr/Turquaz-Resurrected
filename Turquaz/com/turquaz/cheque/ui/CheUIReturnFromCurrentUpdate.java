...
/**
 * @author Onsel
 * @version $Id: CheUIReturnFromCurrentUpdate.java,v 1.7 2005/03/26 15:06:17 onsel Exp $
 */
...
public class CheUIReturnFromCurrentUpdate extends org.eclipse.swt.widgets.Dialog
{
	...
	public CheUIReturnFromCurrentUpdate(Shell parent, int style, TurqChequeRoll chequeRoll)
	{
		super(parent, style);
		...
		try
		{
			if (compChequeRoll.verifyFields())
			{
				...
				CheBLUpdateChequeRoll.updateChequeRollIn(chequeRoll, null, null, null, compChequeRoll.getTxtRollNo().getText().trim(),
						compChequeRoll.getDatePicker1().getDate(), chequeList, EngBLCommon.CHEQUE_TRANS_RETURN_TO_CURRENT.intValue(),
