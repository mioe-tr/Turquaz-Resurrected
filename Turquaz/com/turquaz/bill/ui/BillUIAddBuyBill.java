 ...
 * @version  $Id: BillUIAddBuyBill.java,v 1.1 2004/11/29 12:28:14 huseyiner Exp $
 */
...
public class BillUIAddBuyBill extends org.eclipse.swt.widgets.Composite
				...
				}
				{
...

					{
						...
						tabItemGeneral.setControl(compGeneral);
						{
							...
							{
								lblCurrentCard = new CLabel(compInfoPanel,
										SWT.NONE);
							...
							{
								txtCurrentCard = new Text(compInfoPanel,
										SWT.SINGLE);
							...
							{
								lblDocumentNo = new CLabel(compInfoPanel,
										SWT.NONE);
							...
							{
								txtDocumentNo = new Text(compInfoPanel,
										SWT.NONE);
							...
							{
								lblBillDocumentNo = new CLabel(compInfoPanel,
										SWT.RIGHT);
							...
							{
								lblDefinition = new CLabel(compInfoPanel,
										SWT.RIGHT);
							...
							{
								txtDefinition = new Text(compInfoPanel,
										SWT.NONE);
							...
							{
								lblDiscountRate = new CLabel(compInfoPanel,
										SWT.LEFT);
							...
							{
								lblPaymentType = new Label(compInfoPanel,
										SWT.RIGHT);
							...
							{
								comboPaymentType = new CCombo(compInfoPanel,
										SWT.NONE);
						...
						}
						{
							...
							{
								btnAddConsignmentRow = new Button(compbuttons,
										SWT.PUSH | SWT.CENTER);
							...
							}
							{
								buttonConsignmentRemove = new Button(
										compbuttons, SWT.PUSH | SWT.CENTER);
						...
						{
							tableConsignmentRows = new Table(compGeneral,
						...
						{
							compTotalsPanel = new Composite(compGeneral,
									SWT.NONE);
							...
							{
								lblDiscountAmount = new CLabel(compTotalsPanel,
										SWT.NONE);
							...
							{
								lblTotalAmount = new CLabel(compTotalsPanel,
										SWT.NONE);
							...
							{
								lblInventoryPrice = new CLabel(compTotalsPanel,
										SWT.NONE);
							...
							{
								txtSubTotal = new CurrencyText(compTotalsPanel,
										SWT.NONE);
							...
							{
								lblTotalVat = new CLabel(compTotalsPanel,
										SWT.NONE);
							...
							{
								txtTotalVat = new CurrencyText(compTotalsPanel,
										SWT.NONE);
							...
							{
								lblSpecialVAT = new Label(compTotalsPanel,
										SWT.NONE);
	...
	public void newForm() {
		BillUIAddBuyBill cardAdd = new BillUIAddBuyBill(this.getParent(), this
				.getStyle());
