...
* @version  $Id: CurBLCurrentCardUpdate.java,v 1.15 2005/03/17 09:31:07 cemdayanik Exp $
*/
...
public class CurBLCurrentCardUpdate {
	...
	public static void updateCurrentCard(TurqCurrentCard currentCard,String currentCode,
	...
	throws Exception
	{
		...
		try
		{				
			updateCurrentCardInfo(session,currentCard,currentCode,cardName,
					cardDefinition,cardAddress,cardDiscountRate,cardDiscountPayment,
					cardCreditLimit,cardRiskLimit,cardTaxDepartment,
					cardTaxNumber,daysToValue);
	...
	public static void updateCurrentCardInfo(Session session,
			TurqCurrentCard currentCard,String currentCode, String cardName,
			String cardDefinition,String cardAddress, BigDecimal cardDiscountRate,
			BigDecimal cardDiscountPayment,	BigDecimal cardCreditLimit,
			BigDecimal cardRiskLimit, String cardTaxDepartment,
			String cardTaxNumber,int daysToValue) throws Exception {
		try{
	...
	public static void updateCurrentCardAccounts(Session session,
			TurqCurrentCard currentCard, Map accounts)
	throws Exception
	{		
	...
	public static void deleteCurrentCardAccounts(Session session,
	...
	public static void updateCurrentCardPhones(Session session,
			TurqCurrentCard currentCard, List phoneList)
	throws Exception
	{		
	...
	public static void deleteCurrentCardPhones(Session session,
			TurqCurrentCard currentCard)
	throws Exception
	{
	...
	public static void updateCurrentCardContact(Session session,
			TurqCurrentCard currentCard, Map contactInfo)
	throws Exception
	{		
	...
	public static void deleteCurrentCardContact(Session session,
			TurqCurrentCard currentCard)
	throws Exception
	{
	...
	public static void updateCurrentCardGroups(Session session,
			TurqCurrentCard currentCard, List groupList)
	throws Exception
	{		
	...
	public static void deleteCurrentCardGroups(Session session,
			TurqCurrentCard currentCard)
	throws Exception
	{
