 ...
 * @version  $Id: CurrentCodePicker.java,v 1.10 2005/03/26 15:06:51 onsel Exp $
 */
 ...
 */
public class CurrentCodePicker extends org.eclipse.swt.widgets.Composite
{
	{
	...
	public void setData2(Object obj)
	{
		...
		else
		{
			...
			if (accountPicker != null)
			{
				...
				{
					accountPicker
							.setData(CurBLCurrentCardSearch.getCurrentAccountingAccount((TurqCurrentCard) obj, pickerAccountType));
				}
				catch (Exception ex)
				{
					Logger loger = Logger.getLogger(this.getClass());
