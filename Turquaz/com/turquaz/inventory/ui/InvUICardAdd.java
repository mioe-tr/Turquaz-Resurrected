...
/**
 * @author onsel
 * @version $Id: InvUICardAdd.java,v 1.19 2004/09/28 12:29:25 onsel Exp $
 */
	...
	*/
	public void initGUI(){
		try {
			...
			btnInvCardPricesPre = new Button(composite3,SWT.PUSH| SWT.CENTER);
			btnInvCardPricesNext = new Button(composite3,SWT.PUSH| SWT.CENTER);
