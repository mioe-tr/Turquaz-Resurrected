...
* @version  $Id: AdmUIUserPermissions.java,v 1.9 2004/11/18 09:20:49 huseyiner Exp $
*/
...
SearchComposite{
	...
	public void postInitGUI(){
		...
		comboPermissionLevel.setText("0"); //$NON-NLS-1$
	...
	public void fillTableUserPermissions(){
		...
		for(int i=0;i<userPermList.size();i++){
			...
			permLevel=userPerm.getUserPermissionsLevel()+""; //$NON-NLS-1$
