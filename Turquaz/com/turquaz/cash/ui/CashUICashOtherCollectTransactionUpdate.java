...
/**
 * @author  Onsel
 * @version  $Id: CashUICashOtherCollectTransactionUpdate.java,v 1.16 2005/06/16 17:56:32 huseyiner Exp $
 */
...
public class CashUICashOtherCollectTransactionUpdate extends Dialog
{
	...
	public CashUICashOtherCollectTransactionUpdate(Shell parent, int style, Integer cashTransId)
	{
		super(parent, style);
