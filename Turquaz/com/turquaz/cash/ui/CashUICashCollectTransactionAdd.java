...
/**
 * @author  Onsel
 * @version  $Id: CashUICashCollectTransactionAdd.java,v 1.15 2005/03/17 15:02:07 onsel Exp $
 */
		...
		try
		{
			if (verifyFields())
			{
				CashBLCashTransactionAdd.saveCurrentTransaction((TurqCashCard) txtCashCard.getData(),
						(TurqCurrentCard) txtCurrentAccount.getData(), EngBLCommon.CASH_CURRENT_COLLECT, null, curTextTotalAmount
