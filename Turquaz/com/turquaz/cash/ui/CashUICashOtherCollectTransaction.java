...
/**
 * @author  Onsel
 * @version  $Id: CashUICashOtherCollectTransaction.java,v 1.9 2005/03/30 16:57:41 onsel Exp $
 */
		...
		try
		{
			if (verifyFields())
			{
				CashBLCashTransactionAdd.saveOtherTransaction((TurqCashCard) txtCashCard.getData(),
						(TurqAccountingAccount) txtAccountingAccount.getData(), EngBLCommon.CASH_OTHER_COLLECT, null,
