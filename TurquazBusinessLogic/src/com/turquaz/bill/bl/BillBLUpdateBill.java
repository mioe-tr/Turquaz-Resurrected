...
public class BillBLUpdateBill
{
	public static HashBag getBillInfo(HashMap argMap)throws Exception
	{
		...
		billInfo.put(EngKeys.CURRENCY_ID,bill.getTurqCurrencyExchangeRate().getTurqCurrencyByExchangeCurrencyId().getId());
		billInfo.put(EngKeys.CURRENCY_ABBR,bill.getTurqCurrencyExchangeRate().getTurqCurrencyByExchangeCurrencyId().getCurrenciesAbbreviation());
	...
	public static void deleteCurrentTransactions(TurqBill bill) throws Exception
	{
		try
		{
			BillDALUpdateBill.deleteCurrentTransactions(bill);
		}
		catch (Exception ex)
		{
			throw ex;
	...
	public static void deleteAccountingTransactions(TurqBill bill) throws Exception
	{
		try
		{
			BillDALUpdateBill.deleteAccountingTransactions(bill);
		}
		catch (Exception ex)
		{
			throw ex;
