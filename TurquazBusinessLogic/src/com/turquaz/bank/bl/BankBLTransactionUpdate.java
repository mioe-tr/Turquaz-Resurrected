...
/**
 * @author Onsel
 * @version $Id: BankBLTransactionUpdate.java,v 1.1 2007/01/22 16:36:34 huseyiner Exp $
 */
...
public class BankBLTransactionUpdate
{
	...
	public static void updateTransferBetweenBanks(HashMap argMap) throws Exception
	{
			...
			transRowDebit.setCreatedBy(username); //$NON-NLS-1$
			transRowDebit.setUpdatedBy(username); //$NON-NLS-1$
