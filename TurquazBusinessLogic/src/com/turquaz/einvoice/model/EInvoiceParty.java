...
/**
 * Fatura tarafý (satýcý veya alýcý). Turquaz {@code TurqCurrentCard} ve
 * {@code TurqCompany} kayýtlarýndan doldurulur.
 */
public class EInvoiceParty {
    ...
    /**
     * TCKN 11 haneli; VKN 10 haneli. Alýcý bireysel mi (e-Arþiv için tipik)
     * yoksa kurumsal mý ayrýmýnda kullanýlýr.
     */
