...
/**
 * Sağlayıcı-bağımsız e-belge modeli. Turquaz fatura kayıtlarından
 * (TurqCurrentTransaction + satırlar) {@code TurqInvoiceMapper} tarafından
...
public class EInvoice {
    ...
    private String ettn;            // 36 karakterlik UUID (boşsa provider/mapper üretir)
    private String series;          // fatura serisi (örn. "TUR")
    private String documentNo;      // tam belge no (seri + sıra), opsiyonel
    private Date issueDate = new Date();
    private String currency = "TRY";

    /** e-Arşiv için satış kanalı: KAGIT / ELEKTRONIK (internet satışı). */
    ...
    /** KDV hariç toplam (mal/hizmet tutarı, satır indirimi düşülmüş). */
