...
/**
 * Fatura satırı. KDV bilgisi Turquaz {@code TurqInventoryTransaction}
 * (vatRate / vatAmount) kayıtlarından gelir.
 */
public class EInvoiceLine {
    ...
    private BigDecimal lineTotal = BigDecimal.ZERO;   // KDV hariç satır tutarı
