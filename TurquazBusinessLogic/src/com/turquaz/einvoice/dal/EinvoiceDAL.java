...
/**
 * e-belge durum/okuma için veri erişimi. Mevcut DAL desenini
 * ({@link EngDALSessionFactory} + {@link EngDALCommon}) yeniden kullanır.
 */
public class EinvoiceDAL {
    ...
    /** Bir faturaya ait mevcut e-belge durum kaydını döndürür (yoksa null). */
