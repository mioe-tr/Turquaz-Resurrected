 ...
 * @version $Id: CurBLTransactionUpdate.java,v 1.1 2007/01/22 16:36:33 huseyiner Exp $
 */
public class CurBLTransactionUpdate
{
	...
	public static HashBag getMultipleVoucherInfo(HashMap argMap)throws Exception
	{
		...
		transBag.put(EngKeys.CURRENCY_ABBR,curTrans.getTurqCurrencyExchangeRate().getTurqCurrencyByExchangeCurrencyId().getCurrenciesAbbreviation());
	...
	public static void updateOtherCurrentTransaction(HashMap argMap) throws Exception
	{
		deleteCurTrans(argMap);
		CurBLCurrentTransactionAdd.saveOtherCurrentTransaction(argMap);
	}
	
	public static void updateCurrentTransferBetweenAccounts(HashMap argMap) throws Exception
	{
		deleteTransfer(argMap);
		
		CurBLCurrentTransactionAdd.saveCurrentTransferBetweenAccounts(argMap);
	}
	...
	public static void updateInitialTransaction(HashMap argMap)throws Exception
	{
		...
		curTrans.setTransactionsTotalDept(dept);
		EngDALCommon.updateObject(curTrans);
		
	}
	
	public static void updateMultipleOtherTransaction(HashMap argMap) throws Exception
	{
		deleteCurTrans(argMap);
		CurBLCurrentTransactionAdd.saveMultipleOtherTransaction(argMap);
	}
