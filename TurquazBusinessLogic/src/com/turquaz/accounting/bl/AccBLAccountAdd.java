 ...
 * @version $Id: AccBLAccountAdd.java,v 1.1 2007/01/22 16:36:35 huseyiner Exp $
 */
...
public class AccBLAccountAdd
{
	...
	public static HashBag getAccountingAccountLists()throws Exception
	{
		...
		accountBag.put(AccKeys.ACC_MAIN_ACCOUNTS,getMainAccounts());
	...
	public static List getMainAccounts() throws Exception
	{
		try
		{
			List accounts=AccDALAccountAdd.getMainAccounts();
			List accountMaps=new ArrayList();
			for(int k=0; k<accounts.size(); k++)
			{
				HashMap accountMap=new HashMap();
	...
	public static void saveAccount(HashMap argMap) throws Exception
	{
		try
		{
