 ...
 * @version $Id: AccBLTransactionUpdate.java,v 1.1 2007/01/22 16:36:35 huseyiner Exp $
 */
...
{	
	...
	public static HashBag getInitialTransaction() throws Exception
	{
		try
		{
			...
			if(trans ==null)
			{
			 trans=	AccBLTransactionAdd.saveInitialTransaction();
			...
			if(trans.getTurqAccountingTransactionColumns()==null)
			{
				return transBag;
			}
