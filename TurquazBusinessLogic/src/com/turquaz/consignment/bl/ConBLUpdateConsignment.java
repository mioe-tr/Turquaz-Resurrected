...
public class ConBLUpdateConsignment
{
    ...
    public static HashBag getConsignmentInfo(HashMap argMap) throws Exception
    {
        ...
        try
        {
			...
			returnBag.put(EngKeys.CURRENCY_ID,cons.getTurqCurrencyExchangeRate().getTurqCurrencyByExchangeCurrencyId().getId());
			returnBag.put(EngKeys.CURRENCY_ABBR,cons.getTurqCurrencyExchangeRate().getTurqCurrencyByExchangeCurrencyId().getCurrenciesAbbreviation());
