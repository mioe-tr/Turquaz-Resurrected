...
public class TurqBankCardsSecondaryAccount implements Serializable {
    ...
    /** full constructor */
    public TurqBankCardsSecondaryAccount(String createdBy, Date creationDate, String updatedBy, Date lastModified, String bankDefinition, com.turquaz.engine.dal.TurqBankSecondaryAccount turqBankSecondaryAccount, com.turquaz.engine.dal.TurqAccountingAccount turqAccountingAccount, com.turquaz.engine.dal.TurqBanksCard turqBanksCard) {
    ...
    /** minimal constructor */
    public TurqBankCardsSecondaryAccount(String createdBy, String updatedBy, Date lastModified, String bankDefinition, com.turquaz.engine.dal.TurqBankSecondaryAccount turqBankSecondaryAccount, com.turquaz.engine.dal.TurqAccountingAccount turqAccountingAccount, com.turquaz.engine.dal.TurqBanksCard turqBanksCard) {
        this.createdBy = createdBy;
        this.updatedBy = updatedBy;
        this.lastModified = lastModified;
        this.bankDefinition = bankDefinition;
