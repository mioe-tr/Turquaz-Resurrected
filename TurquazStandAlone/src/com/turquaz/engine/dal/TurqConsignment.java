...
public class TurqConsignment implements Serializable {
    ...
    /** full constructor */
    public TurqConsignment(Date consignmentsDate, String consignmentsDefinition, int consignmentsType, boolean consignmentsPrinted, String createdBy, Date creationDate, String updatedBy, Date lastModified, String consignmentDocumentNo, String billDocumentNo, com.turquaz.engine.dal.TurqCurrencyExchangeRate turqCurrencyExchangeRate, com.turquaz.engine.dal.TurqEngineSequence turqEngineSequence, com.turquaz.engine.dal.TurqCurrentCard turqCurrentCard, Set turqConsignmentsInGroups) {
    ...
    public Date getConsignmentsDate() {
        return this.consignmentsDate;
    }

    public void setConsignmentsDate(Date consignmentsDate) {
        this.consignmentsDate = consignmentsDate;
    }

    public String getConsignmentsDefinition() {
        return this.consignmentsDefinition;
    }

    public void setConsignmentsDefinition(String consignmentsDefinition) {
        this.consignmentsDefinition = consignmentsDefinition;
    }
    ...
    public String getConsignmentDocumentNo() {
        return this.consignmentDocumentNo;
    }

    public void setConsignmentDocumentNo(String consignmentDocumentNo) {
        this.consignmentDocumentNo = consignmentDocumentNo;
    }

    public String getBillDocumentNo() {
        return this.billDocumentNo;
    }

    public void setBillDocumentNo(String billDocumentNo) {
        this.billDocumentNo = billDocumentNo;
    }
    ...
    public Set getTurqConsignmentsInGroups() {
        return this.turqConsignmentsInGroups;
    }

    public void setTurqConsignmentsInGroups(Set turqConsignmentsInGroups) {
        this.turqConsignmentsInGroups = turqConsignmentsInGroups;
    }
