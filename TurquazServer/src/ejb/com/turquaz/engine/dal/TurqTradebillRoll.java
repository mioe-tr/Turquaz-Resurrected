...
public class TurqTradebillRoll implements Serializable {
    ...
    /** persistent field */
    private Date tradebillRollsDate;
    ...
    /** full constructor */
    public TurqTradebillRoll(Date tradebillRollsDate, String createdBy, Date creationDate, String updatedBy, Date lastModified, com.turquaz.engine.dal.TurqBanksCard turqBanksCard, com.turquaz.engine.dal.TurqCurrentCard turqCurrentCard, com.turquaz.engine.dal.TurqTradebillTransactionType turqTradebillTransactionType, Set turqTradebillTradebillsRolls) {
    ...
    public Date getTradebillRollsDate() {
        return this.tradebillRollsDate;
    }

    public void setTradebillRollsDate(Date tradebillRollsDate) {
        this.tradebillRollsDate = tradebillRollsDate;
    }
